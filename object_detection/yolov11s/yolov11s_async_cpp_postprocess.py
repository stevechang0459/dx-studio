...
Usage:
    python yolov11s_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov11sFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv11s Async Inference")
def main():
    args = parse_args()
    factory = Yolov11sFactory()
