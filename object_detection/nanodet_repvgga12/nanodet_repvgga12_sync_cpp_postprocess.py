...
"""
NanoDet-RepVGGA12 Synchronous Inference Example

Usage:
    python nanodet_repvgga12_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("NanoDet-RepVGGA12 Sync Inference (C++ Postprocess)")
def main():
    args = parse_args()
