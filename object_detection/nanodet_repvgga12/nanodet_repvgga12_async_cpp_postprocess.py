...
"""
NanoDet-RepVGGA12 Asynchronous Inference Example

Usage:
    python nanodet_repvgga12_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from dx_postprocess import YOLOXPostProcess
from dx_engine import InferenceOption
from common.utility import convert_cpp_detections
from factory import Nanodet_repvgga12Factory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("NanoDet-RepVGGA12 Asyn Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Nanodet_repvgga12Factory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOXPostProcess(
