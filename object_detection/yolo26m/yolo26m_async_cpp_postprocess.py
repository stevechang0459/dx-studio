...
"""
Object Detection Asynchronous Inference Example

Usage:
    python yolo26m_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from dx_postprocess import YOLOv26PostProcess
from dx_engine import InferenceOption
from common.utility import convert_cpp_detections
from factory import Yolo26mFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv26m Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolo26mFactory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv26PostProcess(input_w, input_h, score_thr, nms_thr, use_ort)
