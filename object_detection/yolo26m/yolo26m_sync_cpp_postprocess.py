...
"""
Object Detection Synchronous Inference Example

Usage:
    python yolo26m_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLOv26m Sync Inference (C++ Postprocess)")
def main():
    args = parse_args()
