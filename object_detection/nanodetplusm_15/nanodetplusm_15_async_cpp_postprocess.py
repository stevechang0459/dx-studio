...
Usage:
    python nanodetplusm_15_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Nanodetplusm_15Factory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("NanoDet Asyn Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Nanodetplusm_15Factory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = NanoDetPostProcess(
            input_w, input_h, score_thr, nms_thr, 80, 7
        )
