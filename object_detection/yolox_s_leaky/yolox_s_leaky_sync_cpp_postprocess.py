...
"""
YOLOX Synchronous Inference Example

Usage:
    python yolox_s_leaky_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolox_s_leakyFactory
from common.runner import SyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOX_S_LEAKY Sync Inference")
def main():
    args = parse_args()
    factory = Yolox_s_leakyFactory()
