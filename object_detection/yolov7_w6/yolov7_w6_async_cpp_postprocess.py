...
"""
Yolov7_w6 Asynchronous Inference Example

Usage:
    python yolov7_w6_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7_w6Factory
