...
"""
Yolov7e6e Asynchronous Inference Example

Usage:
    python yolov7e6e_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7e6eFactory
