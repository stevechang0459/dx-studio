...
Usage:
    python yolov8s_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8sFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv8s Async Inference")
def main():
    args = parse_args()
    factory = Yolov8sFactory()
