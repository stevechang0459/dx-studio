...
Usage:
    python yolov8m_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8mFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv8m Async Inference")
def main():
    args = parse_args()
    factory = Yolov8mFactory()
