...
Usage:
    python yolo26s_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo26sFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv26s Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolo26sFactory()
