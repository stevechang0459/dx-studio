...
Usage:
    python damoyolo_tinynasl35_m_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
def parse_args():
    return parse_common_args("DAMO-YOLO-TINYNASL35_M Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
