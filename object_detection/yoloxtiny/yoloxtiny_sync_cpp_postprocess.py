...
Usage:
    python yoloxtiny_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import YoloxtinyFactory
from common.runner import SyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOX-TINY Sync Inference")
def main():
    args = parse_args()
    factory = YoloxtinyFactory()
