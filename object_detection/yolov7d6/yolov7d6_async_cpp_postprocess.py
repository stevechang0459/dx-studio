...
"""
Yolov7d6 Asynchronous Inference Example

Usage:
    python yolov7d6_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7d6Factory
