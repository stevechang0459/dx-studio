...
"""
Yolov11 Asynchronous Inference Example

Usage:
    python yolov11n_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from dx_postprocess import YOLOv11PostProcess
from dx_engine import InferenceOption
from common.utility import convert_cpp_detections
from factory import Yolov11Factory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv11n Async Inference")
def main():
    args = parse_args()
    factory = Yolov11Factory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv11PostProcess(input_w, input_h, score_thr, nms_thr, use_ort)
