...
"""
Yolov11 Synchronous Inference Example

Usage:
    python yolov11n_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("YOLOv11n Sync Inference")
def main():
    args = parse_args()
