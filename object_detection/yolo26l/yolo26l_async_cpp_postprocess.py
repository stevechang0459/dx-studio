...
Usage:
    python yolo26l_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo26lFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv26l Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolo26lFactory()
