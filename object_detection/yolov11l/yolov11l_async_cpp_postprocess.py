...
Usage:
    python yolov11l_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov11lFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv11l Async Inference")
def main():
    args = parse_args()
    factory = Yolov11lFactory()
