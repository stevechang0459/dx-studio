...
Usage:
    python yolov9_gelan_c_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov9_gelan_cFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv9t Async Inference")
def main():
    args = parse_args()
    factory = Yolov9_gelan_cFactory()
