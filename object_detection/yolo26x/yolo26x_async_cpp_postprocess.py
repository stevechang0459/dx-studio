...
Usage:
    python yolo26x_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo26xFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv26x Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolo26xFactory()
