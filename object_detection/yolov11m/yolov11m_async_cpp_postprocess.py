...
Usage:
    python yolov11m_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov11mFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv11m Async Inference")
def main():
    args = parse_args()
    factory = Yolov11mFactory()
