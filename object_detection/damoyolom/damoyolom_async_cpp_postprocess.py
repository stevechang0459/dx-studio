...
Usage:
    python damoyolom_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import DamoyolomFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("DAMO-YOLO-M Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = DamoyolomFactory()
