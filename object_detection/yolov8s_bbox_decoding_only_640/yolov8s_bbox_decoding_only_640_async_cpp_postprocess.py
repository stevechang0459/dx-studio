...
"""
Yolov8 Asynchronous Inference Example

Usage:
    python yolov8s_bbox_decoding_only_640_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov8s_bbox_decoding_only_640Factory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv8n Async Inference")
def main():
    args = parse_args()
    factory = Yolov8s_bbox_decoding_only_640Factory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv8PostProcess(input_w, input_h, score_thr, nms_thr, use_ort)
