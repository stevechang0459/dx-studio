...
Usage:
    python yolov9c_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov9cFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv9c Async Inference")
def main():
    args = parse_args()
    factory = Yolov9cFactory()
