...
Usage:
    python yolov11x_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov11xFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv11x Async Inference")
def main():
    args = parse_args()
    factory = Yolov11xFactory()
