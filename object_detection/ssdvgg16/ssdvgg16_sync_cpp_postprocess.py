...
"""
SSD Synchronous Inference Example

Usage:
    python ssdvgg16_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("SSD Sync Inference (C++ Postprocess)")
def main():
    args = parse_args()
