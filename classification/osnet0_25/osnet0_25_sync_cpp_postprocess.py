...
"""
Classification Synchronous Inference Example

Usage:
    python osnet0_25_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("OSNet-0.25 Sync Inference")
def main():
    args = parse_args()
    factory = Osnet0_25Factory()
