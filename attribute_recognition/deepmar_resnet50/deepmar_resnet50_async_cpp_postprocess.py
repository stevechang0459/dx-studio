...
"""
DeepMAR-ResNet50 Asynchronous Inference Example

NOTE: No C++ AttributePostProcess binding available.
      Uses Python attribute postprocessor from factory.

Usage:
    python deepmar_resnet50_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("DeepMAR-ResNet50 Async Inference")
def main():
    args = parse_args()
