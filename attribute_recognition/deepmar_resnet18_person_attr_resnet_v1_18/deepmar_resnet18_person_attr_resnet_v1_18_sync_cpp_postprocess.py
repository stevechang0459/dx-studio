...
"""
DeepMAR-ResNet18 Synchronous Inference Example

NOTE: No C++ AttributePostProcess binding available.
      Uses Python attribute postprocessor from factory.

Usage:
    python deepmar_resnet18_person_attr_resnet_v1_18_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("DeepMAR-ResNet18 Sync Inference")
def main():
    args = parse_args()
