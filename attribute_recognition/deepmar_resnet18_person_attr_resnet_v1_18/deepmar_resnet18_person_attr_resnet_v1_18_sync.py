...
"""
Deepmar_resnet18_person_attr_resnet_v1_18 Synchronous Inference Example

Usage:
    python deepmar_resnet18_person_attr_resnet_v1_18_sync.py --model model.dxnn --image input.jpg
"""
