...
"""
Deepmar_resnet18_person_attr_resnet_v1_18 Asynchronous Inference Example

Usage:
    python deepmar_resnet18_person_attr_resnet_v1_18_async.py --model model.dxnn --image input.jpg
"""
