...
Usage:
    python yolov4_2_ppu_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from dx_postprocess import YOLOv5PPUPostProcess
from dx_engine import InferenceOption
from common.utility import convert_cpp_detections
from factory import Yolov4_2_ppuFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv5s-PPU Async Inference")
def main():
    args = parse_args()
    factory = Yolov4_2_ppuFactory()
