...
"""
Yolov7 PPU Asynchronous Inference Example

Usage:
    python yolov7_ppu_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7PpuFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv7-PPU Async Inference")
def main():
    args = parse_args()
    factory = Yolov7PpuFactory()
