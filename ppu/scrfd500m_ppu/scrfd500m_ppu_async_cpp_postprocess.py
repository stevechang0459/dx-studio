...
"""
SCRFD500M PPU Asynchronous Inference Example

Usage:
    python scrfd500m_ppu_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("SCRFD500M-PPU Async Inference")
def main():
    args = parse_args()
