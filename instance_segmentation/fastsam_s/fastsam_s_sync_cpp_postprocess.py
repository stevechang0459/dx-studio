...
"""
FastSAM Synchronous Inference Example

Usage:
    python fastsam_s_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("FastSAM-S Sync Inference")
def main():
    args = parse_args()
