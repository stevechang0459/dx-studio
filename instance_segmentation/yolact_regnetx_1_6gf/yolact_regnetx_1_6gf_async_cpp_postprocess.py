...
"""
YOLACT Asynchronous Inference Example

Usage:
    python yolact_regnetx_1_6gf_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
def parse_args():
    return parse_common_args("YOLACT Asyn Inference (C++ Postprocess)")
def main():
    args = parse_args()
