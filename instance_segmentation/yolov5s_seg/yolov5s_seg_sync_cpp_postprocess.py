...
"""
Yolov5Seg Synchronous Inference Example

Usage:
    python yolov5s_seg_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov5s_segFactory
from common.runner import SyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv5s-SEG Sync Inference")
def main():
    args = parse_args()
    factory = Yolov5s_segFactory()
