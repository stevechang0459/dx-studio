...
"""
Yolov8Pose Synchronous Inference Example

Usage:
    python yolo26x_pose_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolo26x_poseFactory
from common.runner import SyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv8s-Pose Sync Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolo26x_poseFactory()
