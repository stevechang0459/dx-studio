...
Usage:
    python centerpose_repvgg_a0_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Centerpose_repvgg_a0Factory
...
def main():
    args = parse_args()
    factory = Centerpose_repvgg_a0Factory()
