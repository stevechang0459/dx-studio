...
"""
CenterPose Asynchronous Inference Example

Usage:
    python centerpose_regnetx_800mf_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Centerpose_regnetx_800mfFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("CenterPose Asyn Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Centerpose_regnetx_800mfFactory()
