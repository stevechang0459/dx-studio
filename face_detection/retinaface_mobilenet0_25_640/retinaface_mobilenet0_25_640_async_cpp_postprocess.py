...
"""
Face Detection Asynchronous Inference Example

Usage:
    python retinaface_mobilenet0_25_640_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
def parse_args():
    return parse_common_args("RetinaFace-MobileNet Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
