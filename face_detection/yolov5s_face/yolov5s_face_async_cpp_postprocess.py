...
Usage:
    python yolov5s_face_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov5faceFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv5s-Face Async Inference")
def main():
    args = parse_args()
    factory = Yolov5faceFactory()
