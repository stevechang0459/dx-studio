...
"""
Ulfgfd_slim_320_without_postprocessing Synchronous Inference Example

Usage:
    python ulfgfd_slim_320_without_postprocessing_sync.py --model model.dxnn --image input.jpg
"""
