...
"""
Ulfgfd_slim_320_without_postprocessing Asynchronous Inference Example

Usage:
    python ulfgfd_slim_320_without_postprocessing_async.py --model model.dxnn --video input.mp4
"""
