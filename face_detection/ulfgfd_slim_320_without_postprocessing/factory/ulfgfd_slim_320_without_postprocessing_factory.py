...
class Ulfgfd_slim_320_without_postprocessingFactory(IFaceFactory):
    """Factory for creating ULFG-Slim face detection components (without model postprocessing)."""
    ...
    def get_model_name(self) -> str:
        return "ulfgfd_slim_320_without_postprocessing"
