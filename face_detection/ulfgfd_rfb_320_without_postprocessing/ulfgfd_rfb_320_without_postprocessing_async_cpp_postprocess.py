...
"""
ULFGFD Asynchronous Inference Example

Usage:
    python ulfgfd_rfb_320_without_postprocessing_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Ulfgfd_rfb_320_without_postprocessingFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("ULFGFD Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Ulfgfd_rfb_320_without_postprocessingFactory()
