...
class Ulfgfd_rfb_320_without_postprocessingFactory(IFaceFactory):
    """Factory for creating ULFG-RFB face detection components (without model postprocessing)."""
    ...
    def get_model_name(self) -> str:
        return "ulfgfd_rfb_320_without_postprocessing"
