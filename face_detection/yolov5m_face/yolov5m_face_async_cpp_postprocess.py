...
Usage:
    python yolov5m_face_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov5m_faceFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv5m-Face Async Inference")
def main():
    args = parse_args()
    factory = Yolov5m_faceFactory()
    ...
    def on_engine_init(runner):
        ...
        runner._cpp_postprocessor = YOLOv5FacePostProcess(input_w, input_h, obj_thr, score_thr, nms_thr, use_ort)
