...
"""
YOLOv7-Face Asynchronous Inference Example

Usage:
    python yolov7s_face_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
from factory import Yolov7s_faceFactory
from common.runner import AsyncRunner, parse_common_args

def parse_args():
    return parse_common_args("YOLOv7-Face Async Inference (C++ Postprocess)")
def main():
    args = parse_args()
    factory = Yolov7s_faceFactory()
