...
"""
Face Alignment Asynchronous Inference Example (C++ Postprocess)

Usage:
    python 3ddfa_v2_mobilnet0_5_120x120_async_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("3DDFA-v2-MobileNet0.5 Async Inference (C++ PP)")
def main():
    args = parse_args()
