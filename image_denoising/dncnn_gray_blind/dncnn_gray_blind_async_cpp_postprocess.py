...
Usage:
    python dncnn_gray_blind_async_cpp_postprocess.py --model model.dxnn --video input.mp4
"""
...
from factory import Dncnn_gray_blindFactory
...
def main():
    args = parse_args()
    factory = Dncnn_gray_blindFactory()
