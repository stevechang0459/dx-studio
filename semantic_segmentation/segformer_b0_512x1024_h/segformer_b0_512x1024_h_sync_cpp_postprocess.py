...
"""
SegFormer-B0 Synchronous Inference Example
...
Usage:
    python segformer_b0_512x1024_h_sync_cpp_postprocess.py --model model.dxnn --image input.jpg
"""
...
def parse_args():
    return parse_common_args("SegFormer-B0 Synchronous Inference")
def main():
    args = parse_args()
